...
"""
def compute_embeddings(qname, aname,vocab2id, vectorlist,disttype):
...
if __name__ == "__main__":   
    ...
    outfile = 'embeddings/embeddings_chen_nowordincontext.txt'
    compute_question2embed(sentences, outfile, vocab2id, vectorlist,disttype)
